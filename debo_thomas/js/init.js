...
function jara_tm_modalbox() {
  ...
  jQuery(".jara_tm_all_wrap").prepend(
    '<div class="jara_tm_modalbox"><div class="box_inner"><div class="close"><a href="#"><i class="icon-cancel"></i></a></div><div class="description_wrap"></div></div></div>'
  );
}
...
function jara_tm_modalbox_news() {
  ...
  var button = jQuery(
    ".jara_tm_news .jara_tm_full_link, .jara_tm_news .list ul li .title a"
  );
  ...
  button.on("click", function () {
    ...
    modalBox
      ...
      .after(
        '<div class="details"><div class="meta"><span>' +
          meta +
          '</span></div><div class="title"><h3>' +
          title +
          "</h3></div></div>"
      );
    jara_tm_data_images();
...
function jara_tm_my_load() {
  ...
  setTimeout(function () {
    jQuery(".jara_tm_all_wrap").addClass("ready");
  }, speed + 2000);
}
